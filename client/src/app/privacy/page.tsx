    ...
    <div className="bg-gradient-to-b from-slate-900 via-slate-50 to-slate-50 min-h-screen">
      ...
      <div className="relative pt-20 pb-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <p className="text-slate-300 text-lg md:text-xl max-w-2xl">Your privacy is our priority. Learn how Zayan Travel and Tour Consultants protects your personal information.</p>
        </div>
      </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden">
          ...
          <div className="px-8 md:px-12 py-12 max-w-none text-slate-600 space-y-8 leading-relaxed">
            ...
            <div id="section-0" className="scroll-mt-8">
              ...
              <p className="pl-9">Welcome to <strong>Zayan Travel and Tour Consultants</strong>. We respect your privacy and are committed to protecting your personal data. This Privacy Policy will inform you as to how we look after your personal data when you visit our website and use our visa consulting services, and tell you about your privacy rights and how the law protects you.</p>
            ...
            <div id="section-4" className="scroll-mt-8">
              ...
              <ul className="space-y-3 pl-6">
                ...
                <li className="flex gap-3">
                  <span className="text-blue-500 font-bold flex-shrink-0">•</span>
                  <span><strong>Translators or legal professionals</strong> strictly partnered with Zayan Travel and Tour Consultants for the purpose of validating your application documents.</span>
                </li>
              </ul>
            </div>
