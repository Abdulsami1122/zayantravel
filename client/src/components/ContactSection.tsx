            ...
            >
              ...
              <div className="relative z-10 flex min-h-[460px] flex-col justify-between p-6 sm:p-8 lg:p-10">
                ...
                <div className="space-y-4 rounded-3xl bg-white/10 p-6 backdrop-blur-sm sm:p-8">
                  ...
                  <a 
                    href="https://maps.google.com/?q=deans+saddar+zayan+travel+consultants+UG:455" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="block mt-4 w-full h-[140px] rounded-2xl overflow-hidden relative group border border-white/20 shadow-inner"
                  >
                    <iframe 
                      src="https://www.google.com/maps?q=deans+saddar+zayan+travel+consultants+UG:455&output=embed"
                      width="100%" 
                      height="100%" 
                    ...
                    <div className="absolute inset-0 bg-slate-900/10 group-hover:bg-slate-900/40 transition-colors duration-300 flex items-center justify-center">
                      <div className="bg-white text-slate-900 text-sm font-semibold px-5 py-2 rounded-full shadow-xl transform translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
                        Open in Maps
                      </div>
                    </div>
                  </a>
